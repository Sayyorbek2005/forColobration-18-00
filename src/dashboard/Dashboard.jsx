...
function Dashboard() {
  ...
  const [users, setUsers] = useState([
    {
      ...
      kurs: "Frontend",
      verselLink: "https://project1.vercel.app",
      testNatija: "25/30",
      ball: 85,
    },
    {
      ...
      kurs: "Node.js",
      verselLink: "https://project2.vercel.app",
      testNatija: "28/30",
      ball: 92,
    },
    {
      ...
      verselLink: "https://project3.vercel.app",
      testNatija: "22/30",
      ball: 78,
    },
  ]);
  ...
  const [amaliyotForm, setAmaliyotForm] = useState({
    fullname: "",
    link: "",
    kurs: "React guruh",
  });
  ...
  const handleAmaliyotSubmit = (e) => {
    ...
    toast.success(
      "Amaliyot muvaffaqiyatli topshirildi va Telegram botga yuborildi!",
    );
  ...
  const handleTestSubmit = (e) => {
    ...
    console.log(
      "Telegram Botga test natijasi ketdi:",
      testForm.fullname,
      umumiyBall,
    );
    ...
    toast.success(
      `Test tugadi! Natija: ${togriJavoblarSoni}/30 botga va foydalanuvchilar ro'yxatiga yuborildi.`,
    );
    ...
    <Container>
      ...
      <Main>
          ...
          >
            ...
            >
              ...
              <Button
                ...
                style={{
                  backgroundColor:
                    activeTab === "amaliyot" ? "#007bff" : "#f0f2f5",
              ...
              <Button
                ...
                style={{
                  backgroundColor:
                    activeTab === "userlar" ? "#007bff" : "#f0f2f5",
          ...
          <>
            ...
            {showGroupForm && (
              <ChartBox>
                ...
                >
                  <FaBookOpen /> Guruh qo'shish
                </h2>
                <Input
                  placeholder="Kurs"
                  value={groupForm.kurs}
                  onChange={(e) =>
                    setGroupForm({ ...groupForm, kurs: e.target.value })
                  }
                />
                <Input
                  ...
                  onChange={(e) =>
                    setGroupForm({ ...groupForm, oqituvchi: e.target.value })
                  }
                />
                <Input
                  placeholder="Narx"
                  ...
                  onChange={(e) =>
                    setGroupForm({ ...groupForm, narx: e.target.value })
                  }
                />
                <Input
                  placeholder="Vaqt"
                  ...
                  onChange={(e) =>
                    setGroupForm({ ...groupForm, vaqt: e.target.value })
                  }
                />
                <Input
                  placeholder="Xona"
                  ...
                  onChange={(e) =>
                    setGroupForm({ ...groupForm, xona: e.target.value })
                  }
                />
                <Input
                  placeholder="Markaz"
                  ...
                  onChange={(e) =>
                    setGroupForm({ ...groupForm, markaz: e.target.value })
                  }
                />
            ...
            {showStudentForm && (
              <ChartBox>
                <h2
                  style={{ display: "flex", alignItems: "center", gap: "10px" }}
                >
                  <FaGraduationCap /> Talaba qo'shish
                </h2>
                <Input
                  placeholder="Ism"
                  value={studentForm.ism}
                  onChange={(e) =>
                    setStudentForm({ ...studentForm, ism: e.target.value })
                  }
                />
                <Input
                  ...
                  onChange={(e) =>
                    setStudentForm({ ...studentForm, familiya: e.target.value })
                  }
                />
                <Select
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setStudentForm({ ...studentForm, telefon: e.target.value })
                  }
                />
                <Input
                  placeholder="Manzil"
                  ...
                  onChange={(e) =>
                    setStudentForm({ ...studentForm, manzil: e.target.value })
                  }
                />
        ...
        {activeTab === "amaliyot" && (
          <ChartBox>
            <h2>
              <FaClipboardList /> Amaliyot vazifasini topshirish
            </h2>
            <form
            ...
            >
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAmaliyotForm({ ...amaliyotForm, kurs: e.target.value })
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAmaliyotForm({ ...amaliyotForm, link: e.target.value })
                  }
                />
              </div>
              <Button type="submit" style={{ marginTop: "10px" }}>
                Botga va Userlarga yuborish
              </Button>
            </form>
          </ChartBox>
        )}
        ...
        {activeTab === "test" && (
          <ChartBox>
            <h2>
              <FaPenSquare /> Bilimni sinash uchun testlar (30 ta)
            </h2>
            <form
            ...
            >
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setTestForm({ ...testForm, fullname: e.target.value })
                  }
                />
              </div>
              ...
              >
                <p>
                  <strong>1-Savol:</strong> React-da component nima?
                </p>
                <label>
                  <input
                    type="radio"
                    ...
                    onChange={() =>
                      setTestForm({
                        ...testForm,
                        belgilanganJavoblar: {
                          ...testForm.belgilanganJavoblar,
                          q1: true,
                        },
                      })
                    }
                  />{" "}
                  Qayta ishlatiladigan kod bo'lagi
                </label>{" "}
                <br />
                <label>
              ...
              >
                <p>
                  <strong>2-Savol:</strong> useState nima uchun ishlatiladi?
                </p>
                <label>
                  <input
                    type="radio"
              ...
              <Button type="submit">
                Natijani botga va Userlarga yuborish
              </Button>
            </form>
          </ChartBox>
        )}
        ...
        {activeTab === "userlar" && (
          <ChartBox>
            <h2>
              <FaUsers /> Foydalanuvchilar Ro'yxati (Natijalar)
            </h2>
            <div
              style={{
                display: "grid",
              ...
              {users.map((user, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <p style={{ margin: 0 }}>
                      <strong>Test Natijasi:</strong> {user.testNatija}
                    </p>
                    <p style={{ margin: 0 }}>
                      <strong>Umumiy Ball:</strong> {user.ball}
                    </p>
                  </div>
                </div>
              ))}
